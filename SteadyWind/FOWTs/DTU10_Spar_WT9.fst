...
"InflowWind_WT9.dat"                                InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../../CommonFiles/Rotor/DTU10_AeroDyn.dat"         AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"DTU10_Spar_ServoDyn_WT9.dat"                       ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
